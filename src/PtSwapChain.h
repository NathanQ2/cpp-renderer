...
public:
  ...
  PtSwapChain(PtWindow &window, PtDevice &device) : window_{window}, device_{device} { init(); }
  ...
  bool compareSwapFormats(VkFormat otherDepthFormat, VkFormat otherImageFormat) const {
    return otherDepthFormat == swapChainDepthFormat && otherImageFormat == swapChainImageFormat;
  }
